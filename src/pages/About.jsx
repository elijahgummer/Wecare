...
import doctor6 from "../components/images/doctor6.png"; // Adjust path as needed
import doctor7 from "../components/images/doctor7.png"; // Adjust path as needed
function AboutPage() {
  return (
	...
	c5.4,1.3,9.2,7.4,9.2,15C58,29.7,57.6,32.1,56.8,34.5z"
      ...
      <div className="team">
        ...
        <div className="team-container">
          ...
          <div className="image-box">
            <img className="doctor" src={doctor2} alt="logo" />
            <h1>DR. JASON BALE</h1>
            <p>Head Surgeon</p>
          </div>
          <div className="image-box">
          ...
          <div className="image-box">
            <img className="doctor" src={doctor4} alt="logo" />
            <h1>DR. MOHAMED SOOD</h1>
            <p>Pediatrician</p>
          </div>
          <div className="image-box">
